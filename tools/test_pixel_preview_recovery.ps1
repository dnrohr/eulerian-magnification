...
Assert-True -Condition ($commands.IndexOf("am force-stop com.dnrohr.eulerianmagnification") -lt $commands.IndexOf("wait_for_device_thermal_ready.ps1")) -Message "Thermal recovery should stop the app before waiting for cooldown."
