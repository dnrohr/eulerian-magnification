...
- [ ] Design a simple list/detail browser for recordings and processed videos.
- [ ] Show metadata summary, artifact links, and share actions.
- [ ] Add delete/cleanup behavior for app-owned artifacts.
- [ ] Avoid turning the main preview into a dashboard.
- [ ] Add tests for gallery ordering and cleanup logic.
