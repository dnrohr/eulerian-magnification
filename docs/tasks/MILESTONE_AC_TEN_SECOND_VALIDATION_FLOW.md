...
- [ ] Define the flow states: setup, countdown, recording, processing, review.
- [ ] Use current mode/preset and guided setup text during setup.
- [ ] Record a fixed-duration clip or processed frames.
- [ ] Automatically generate MP4, metadata, CSV, and later plot artifacts.
- [ ] Show a concise result summary with share buttons.
- [ ] Add tests for flow state transitions and metadata.
