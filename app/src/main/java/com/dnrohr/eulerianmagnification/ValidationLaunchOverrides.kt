...
data class ValidationLaunchOverrides(
    ...
    companion object {
        ...
        const val EXTRA_CAMERA_SESSION = "validation.cameraSession"
        ...
        fun fromMap(values: Map<String, String?>): ValidationLaunchOverrides {
            return ValidationLaunchOverrides(
                ...
                cameraSession = values[EXTRA_CAMERA_SESSION]?.trim()?.takeIf { it.isNotEmpty() },
